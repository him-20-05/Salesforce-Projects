Webruntime.define('lwc/covidApp', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

  function stylesheet(hostSelector, shadowSelector, nativeShadow) {
    return ".app-container" + shadowSelector + " {min-height: 100vh;background:#fff;color:#9d9d9d;padding-bottom: 1rem;}\n*" + shadowSelector + "," + shadowSelector + " ::after," + shadowSelector + " ::before {box-sizing: border-box;}\nheader" + shadowSelector + ", footer" + shadowSelector + "{grid-area: header;text-align: center;margin: 0;padding: 0.5em;background: #222;color:#9d9d9d;font-size: 1.5em;}\n.bg-primary" + shadowSelector + " {background-color: #007bff;}\n.bg-warning" + shadowSelector + " {background-color: #dd9105;}\n.bg-success" + shadowSelector + " {background-color: #28a745;}\n.bg-danger" + shadowSelector + " {background-color: #dc3545;}\n.bg-info" + shadowSelector + " {background-color: #17a2b8;}\n.bg-secondary" + shadowSelector + " {background-color: #413b7f;}\n.bg-light" + shadowSelector + " {background-color: #2664a2!important;}\n.white-color" + shadowSelector + "{color:white;}\n.space" + shadowSelector + "{justify-content: space-between;}\n.table-bordered" + shadowSelector + " {border: 1px solid #dee2e6;}\n.table" + shadowSelector + " {width: 100%;margin-bottom: 1rem;color: #212529;background: #fff;}\ntable" + shadowSelector + " {display: table;border-collapse: collapse;border-spacing: 2px;border-color: grey;}\n.table-bordered" + shadowSelector + " thead" + shadowSelector + " td" + shadowSelector + ", .table-bordered" + shadowSelector + " thead" + shadowSelector + " th" + shadowSelector + " {border-bottom-width: 2px;}\n.table" + shadowSelector + " thead" + shadowSelector + " th" + shadowSelector + " {vertical-align: bottom;border-bottom: 2px solid #dee2e6;background: #1b262c;color: white;}\n.table-bordered" + shadowSelector + " td" + shadowSelector + ", .table-bordered" + shadowSelector + " th" + shadowSelector + " {border: 1px solid #dee2e6;}\n.table" + shadowSelector + " td" + shadowSelector + ", .table" + shadowSelector + " th" + shadowSelector + " {padding: .75rem;vertical-align: top;border-top: 1px solid #dee2e6;font-size: 1rem;}\nth" + shadowSelector + " {text-align: inherit;}\n.table-bordered" + shadowSelector + " td" + shadowSelector + ", .table-bordered" + shadowSelector + " th" + shadowSelector + " {border: 1px solid #dee2e6;}\n.table" + shadowSelector + " td" + shadowSelector + ", .table" + shadowSelector + " th" + shadowSelector + " {padding: .75rem;vertical-align: top;border-top: 1px solid #dee2e6;}\nh1" + shadowSelector + "{text-align: center;font-size: 2rem;font-weight: 700px;}\n.lgc-bg" + shadowSelector + " {background-color: #0f4c81;}\n.label-text" + shadowSelector + "{color:#fff !important;font-size: 1rem;}\nlightning-input.label-text.slds-form-element" + shadowSelector + " label" + shadowSelector + " {color: #fff;}\n.activeColumnClass" + shadowSelector + "{background-color:#fe346e;color:#fff;}\n.recoveredColumnClass" + shadowSelector + "{background-color:#5b8c5a;color:#fff;}\n.fatalityColumnClass-success" + shadowSelector + "{background-color:#1eb2a6;color:#fff;}\n.fatalityColumnClass-danger" + shadowSelector + "{background-color:#d63447;color:#fff;}\n.recoveryColumnClass-warning" + shadowSelector + "{background-color:#ffac41;color:#fff;}\n.recoveryColumnClass-success" + shadowSelector + "{background-color:#48c774;color:#fff;}\n.countryName" + shadowSelector + "{font-size: 1.5rem;font-weight: 700;}\n.toggle-container" + shadowSelector + "{display: flex;justify-content: flex-end;color:#fff;}\n.toggle-container" + shadowSelector + ">div" + shadowSelector + "{padding: 0.5rem 1rem;background: #fff;border:1px solid #212529;color: #000;}\n.toggle-container" + shadowSelector + ">div.active" + shadowSelector + "{background: #28a745;color:#fff;}\n.box-container" + shadowSelector + "{display: flex;justify-content: space-between;align-items: baseline;}\n";
  }
  ...
  **/
  ...
  if (_implicitStylesheets$5) {
    tmpl$9.stylesheets.push.apply(tmpl$9.stylesheets, _implicitStylesheets$5);
  }
  ...
  */
  ...
  if (_implicitStylesheets$4) {
    tmpl$l.stylesheets.push.apply(tmpl$l.stylesheets, _implicitStylesheets$4);
  }
  ...
  * */
  ...
  function tmpl$m($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("COVID-19 Global Cases tracking using LWC ")]), api_element("div", {
      classMap: {
      ...
      key: 1
    }, [api_text("Total Confirmed")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
      ...
      key: 2
    }, [api_dynamic($cmp.total.total_confirmed)])]), api_element("div", {
      classMap: {
        "slds-col": true,
        "bg-warning": true,
        "slds-p-around_small": true,
      ...
      key: 4
    }, [api_text("Total Active")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
        "slds-text-heading_large": true,
        "white-color": true
      ...
      key: 5
    }, [api_dynamic($cmp.total.total_active)])]), api_element("div", {
      classMap: {
        "slds-col": true,
        "bg-success": true,
        "slds-p-around_small": true,
      ...
      key: 7
    }, [api_text("Total Recovered")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
        "slds-text-heading_large": true,
        "white-color": true
      ...
      key: 8
    }, [api_dynamic($cmp.total.total_recovered)])]), api_element("div", {
      classMap: {
        "slds-col": true,
        "bg-danger": true,
        "slds-p-around_small": true,
      ...
      key: 10
    }, [api_text("Total Deaths")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
        "slds-text-heading_large": true,
        "white-color": true
      ...
      key: 11
    }, [api_dynamic($cmp.total.total_deaths)])]), api_element("div", {
      classMap: {
        "slds-col": true,
        "bg-info": true,
        "slds-p-around_small": true,
      ...
      key: 13
    }, [api_text("Fatality Rate")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
        "slds-text-heading_large": true,
        "white-color": true
      ...
      key: 14
    }, [api_dynamic($cmp.total.total_fatality_rate)])]), api_element("div", {
      classMap: {
        "slds-col": true,
        "bg-secondary": true,
        "slds-p-around_small": true,
      ...
      key: 16
    }, [api_text("Recovery Rate")]), api_element("div", {
      classMap: {
        "slds-text-align_center": true,
        "slds-text-heading_large": true,
        "white-color": true
      ...
      key: 17
    }, [api_dynamic($cmp.total.total_recovery_rate)])])]), api_element("div", {
      classMap: {
        "slds-m-left_medium": true,
        "slds-m-right_medium": true
      },
      key: 26
    }, [api_element("div", {
      classMap: {
      ...
      key: 20
    }, [api_text("COVID Data by country")]), api_element("div", {
      classMap: {
        "toggle-container": true
      },
      key: 23
    }, [api_element("div", {
      className: $cmp.isListSelected,
      attrs: {
        "data-name": "LIST"
      },
      key: 21,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.listHandler))
      }
    }, [api_text("List")]), api_element("div", {
      className: $cmp.isChartSelected,
      attrs: {
        "data-name": "CHART"
      },
      key: 22,
      on: {
        "click": _m1 || ($ctx._m1 = api_bind($cmp.listHandler))
      }
    }, [api_text("Chart")])])])])]), !$cmp.showListView ? api_element("div", {
      classMap: {
        "slds-m-left_medium": true,
        "slds-m-right_medium": true,
      ...
      key: 27
    }, [api_text("Select Your country")]), api_custom_element("lightning-combobox", _lightningCombobox, {
      props: {
        "name": "country",
        "label": "country",
        "value": $cmp.countrySelected,
        "placeholder": "Select Your country",
        "options": $cmp.countryList,
        "variant": "label-hidden"
      },
      key: 28,
      on: {
        "change": _m2 || ($ctx._m2 = api_bind($cmp.handleCountryChange))
      }
    }, [])])]) : null, !$cmp.showListView ? api_element("div", {
      classMap: {
        "chartContainer": true
      },
      context: {
      ...
      key: 32
    }, [api_text("Enter Your country Name")]), api_custom_element("lightning-input", _lightningInput, {
      props: {
        "type": "text",
        "autocomplete": "off",
      ...
      key: 33,
      on: {
        "keyup": _m3 || ($ctx._m3 = api_bind($cmp.searchHandler))
      }
    }, []), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_medium": true,
        "fatalityColumnClass-danger": true
      },
      key: 34
    }, [api_text("Higher than Average Fatality")]), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_medium": true,
        "recoveryColumnClass-success": true
      },
      key: 35
    }, [api_text("Higher than Average Recovery")]), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_medium": true,
        "recoveryColumnClass-warning": true
      },
      key: 36
    }, [api_text("Lower than Average Recovery")]), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_x-medium": true,
        "fatalityColumnClass-success": true
      },
      key: 37
    }, [api_text("Lower than Average Fatality")]), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_x-medium": true,
        "activeColumnClass": true
      },
      key: 38
    }, [api_text("More Active than Recovered")]), api_element("span", {
      classMap: {
        "slds-badge": true,
        "slds-m-around_x-medium": true,
        "recoveredColumnClass": true
      },
      key: 39
    }, [api_text("More Recovered than Active")])]), api_element("table", {
      classMap: {
        "table": true,
        "table-bordered": true
      },
      ...
      key: 41
    }, [api_text("Country Name")]), api_element("th", {
      key: 42
    }, [api_text("Confirmed")]), api_element("th", {
      key: 43
    }, [api_text("Active")]), api_element("th", {
      key: 44
    }, [api_text("Recovered")]), api_element("th", {
      key: 45
    }, [api_text("Deaths")]), api_element("th", {
      key: 46
    }, [api_text("Fatality Rate")]), api_element("th", {
      key: 47
    }, [api_text("Recovery Rate")]), api_element("th", {
      key: 48
    }, [api_text("Last Updated")])])]), api_element("tbody", {
      attrs: {
        "id": api_scoped_id("myTable")
      },
      key: 61
    }, api_flatten([api_iterator($cmp.filteredtableData, function (item) {
      return api_element("tr", {
        key: api_key(59, item.Country_Region)
      }, [api_element("td", {
        classMap: {
          "countryName": true
        },
        key: 51
      }, [api_dynamic(item.Country_Region)]), api_element("td", {
        key: 52
      }, [api_dynamic(item.Confirmed)]), api_element("td", {
        className: item.activeColumnClass,
        key: 53
      }, [api_dynamic(item.Active)]), api_element("td", {
        className: item.recoveredColumnClass,
        key: 54
      }, [api_dynamic(item.Recovered)]), api_element("td", {
        key: 55
      }, [api_dynamic(item.Deaths)]), api_element("td", {
        className: item.fatalityColumnClass,
        key: 56
      }, [api_dynamic(item.Fatality_rate)]), api_element("td", {
        className: item.recoveryColumnClass,
        key: 57
      }, [api_dynamic(item.Recovery_Rate)]), api_element("td", {
        key: 58
      }, [api_dynamic(item.formatedDate)])]);
    }), !$cmp.filteredtableData.length ? api_element("div", {
      key: 60
    }, [api_text("No Data Found")]) : null]))])]) : null, api_element("footer", {
      key: 67
    }, [api_element("span", {
      key: 65
    }, [api_text("Build by "), api_element("a", {
      attrs: {
        "href": "",
        "target": "_blank"
      },
      key: 64
    }, [api_text("Himanshu Tiwari")])]), api_element("a", {
      classMap: {
        "slds-float_right": true
      },
      attrs: {
        "href": "https://www.who.int/emergencies/diseases/novel-coronavirus-2019?gclid=Cj0KCQjwj_ajBhCqARIsAA37s0xvF9hm-4mx0s8w6i_9vDIYtlLCvYUoWpXGVC0mg_q6h4gc8eHyksMaAjh4EALw_wcB",
        "target": "_blank"
      },
      key: 66
    }, [api_text("Data Source")])])])];
  }
  ...
  tmpl$m.stylesheetTokens = {
    hostAttribute: "lwc-covidApp_covidApp-host",
    shadowAttribute: "lwc-covidApp_covidApp"
  };
  ...
  const URL = "https://www.who.int/emergencies/diseases/novel-coronavirus-2019?gclid=Cj0KCQjwj_ajBhCqARIsAA37s0xvF9hm-4mx0s8w6i_9vDIYtlLCvYUoWpXGVC0mg_q6h4gc8eHyksMaAjh4EALw_wcB";
  let initialValue = {
    total_deaths: 0,
    total_confirmed: 0,
    total_active: 0,
  ...
  class CovidApp extends lwc.LightningElement {
    constructor(...args) {
      super(...args);
    ...
    renderedCallback() {
      ...
      Promise.all([loadScript(this, 'https://code.highcharts.com/highcharts.js')]).then(() => {
    ...
    formatData(result) {
      ...
      let finalData = Object.keys(individualSum).map(data => {
        ...
        let fatalityColumnClass = this.getFRate(item) > this.getFRate() ? "fatalityColumnClass-danger" : this.getFRate(item) < this.getFRate() ? "fatalityColumnClass-success" : "";
        let recoveryColumnClass = this.getRRate(item) > this.getRRate() ? "recoveryColumnClass-success" : this.getRRate(item) < this.getRRate() ? "recoveryColumnClass-warning" : "";
  ...
  lwc.registerDecorators(CovidApp, {
    track: {
      tableData: 1,
      filteredtableData: 1,
      total: 1,
    ...
    fields: ["chartInitialized"]
  });
  var covidApp = lwc.registerComponent(CovidApp, {
    tmpl: _tmpl$l
  });
