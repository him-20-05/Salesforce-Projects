Webruntime.define('lwc/schedulePage', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        key: 3
      }, [api_text("Schedule Job"), api_element("div", {
        key: 2
      }, [api_custom_element("lightning-input", _lightningInput, {
        key: 0
      }, [api_text("Job Name")]), api_custom_element("lightning-input", _lightningInput, {
        key: 1
      }, [api_text("Apex Job")])])])];
    }
    ...
    tmpl$m.stylesheetTokens = {
      hostAttribute: "lwc-schedulePage_schedulePage-host",
      shadowAttribute: "lwc-schedulePage_schedulePage"
    };

    class SchedulePage extends lwc.LightningElement {}
    var schedulePage = lwc.registerComponent(SchedulePage, {
      tmpl: _tmpl$l
    });
