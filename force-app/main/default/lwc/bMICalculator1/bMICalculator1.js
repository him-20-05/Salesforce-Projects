...
export default class BMICalculator1 extends LightningElement {
  @track height = '';
  @track weight = '';
  ...
  calculateBMI() {
    ...
    this.bmiCategory = this.getBmiCategory(this.bmiValue.toFixed(1)); // Convert to string only for display
